...
import com.gbc.mc.controller.CashInController;
import com.gbc.mc.controller.ZaloPayUserController;
...
public class WebServer implements Runnable{
    ...
    public void run() {
        try {
            ...
            servletContext.addServlet(CashInController.class, "/v001/mc/api/cashin/*");  
            servletContext.addServlet(ZaloPayUserController.class, "/v001/mc/api/zpuserinfo/*");  
